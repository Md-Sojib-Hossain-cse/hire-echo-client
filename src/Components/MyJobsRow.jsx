...
const MyJobsRow = ({ singleJobData  , handleDelete}) => {
    ...
    return (
        <tr className="hover">
            ...
            <td>{salaryRange}</td>
            <td><button className="lg:btn-xs bg-blue-400 text-white rounded-lg md:rounded-sm btn">View Details</button></td>
            <td className="flex gap-4 justify-start items-center">
                <button title="update" className="text-lg font-bold p-2 rounded-lg text-blue-400 hover:bg-blue-400 hover:text-white transition duration-200"><MdOutlineBrowserUpdated /></button>
