...
const AppliedJobsCard = ({ singleJob }) => {
    ...
    return (
        <div className="grid grid-cols-4 p-4 md:p-6 gap-4 md:gap-6 border shadow-lg rounded-tl-3xl rounded-br-3xl hover:border-r-2  hover:border-l-2 hover:border-t-0 hover:border-b-0 hover:border-blue-400 hover:-translate-y-3 transition duration-300 delay-75">
            <div>
